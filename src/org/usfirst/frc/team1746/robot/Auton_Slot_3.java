...
public class Auton_Slot_3 {
	Robot robot;
	
	public Auton_Slot_3(Robot robot) {
		this.robot = robot;
	}
	...
	double DEFENSE_TO_TURN = 137/WHEEL_CIRCUMFRANCE*100; //137 inches
	double TURN_TO_TOWER = 11/WHEEL_CIRCUMFRANCE*100; //60 degrees
	double DRIVE_TO_TOWER = 100/WHEEL_CIRCUMFRANCE*100; //100 inches
